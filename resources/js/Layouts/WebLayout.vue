    ...
    <header>
        ...
        <nav class="shadow">
            ...
            <div class="flex justify-between items-center py-6 px-10 container mx-auto">
                ...
                <div class="flex">
                    <div class="shrink-0 flex items-center"><a href="http://localhost:8000/member/dashboard"><img
                                src="/images/site_logo.png" class="block h-14 w-auto"></a></div>
                    <h1
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        <ul class="sm:flex space-x-4 hidden items-center">
                            <li><a href="https://onlinejua.org" target="_blank"
                                    class="text-gray-700 hover:text-indigo-600 text-md ">JUA</a></li>
