        ...
        <div class="bg-white relative shadow rounded-lg overflow-x-auto p-3">
          <div v-for="courseModule in course.modules" >
            <a-typography-title :level="3">
              ...
              <span v-else>
                {{ courseModule.label }}
                <span role="img" aria-label="form" class="anticon anticon-form ant-menu-item-icon" @click="courseModule.edit=true">
            ...
            <div v-for="content in course.contents">
              <div v-if="content.module==courseModule.value">
                ...
                <inertia-link :href="route('manage.course.contents.edit', {course:content.course_id, content:content.id})">
