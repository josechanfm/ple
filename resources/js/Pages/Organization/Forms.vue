        ...
        <a-table :dataSource="forms" :columns="columns">
            ...
            <template #bodyCell="{column, text, record, index}">
                <template v-if="column.dataIndex=='operation'">
                    <inertia-link :href="route('manage.form.entries.index',{form:record.id})" class="ant-btn">Responses</inertia-link>
                    <a :href="route('manage.entry.export',{form:record.id})" class="ant-btn">Export</a>
                    <inertia-link :href="route('manage.form.fields.index',{form:record.id})" class="ant-btn">Data Fields</inertia-link>
