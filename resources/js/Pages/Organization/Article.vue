<template>
    <OrganizationLayout title="Dashboard">
        ...
        <div>
            <a-button @click="isDrawerVisible=!isDrawerVisible" type="primary" >Images</a-button>
        </div>
        <a-button @click="getCursor()">cursor</a-button>
        ...
        <div>
            <div v-if="selectedMedia">
                ...
                <a-button @click="addToArticle">Add</a-button>
            </div>
        </div>
        </a-drawer>
    </OrganizationLayout>
